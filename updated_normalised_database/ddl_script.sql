...
CREATE TABLE Items (
    ...
    CategoryID          VARCHAR2(10)                         NOT NULL,
    SellingUnitPrice    NUMBER(12,2)                         NOT NULL,
    PurchaseUnitPrice   NUMBER(12,2)                         NOT NULL,
    CONSTRAINT PK_Items
        PRIMARY KEY (ItemID),
    CONSTRAINT CK_Items_SellingUnitPrice
        CHECK (SellingUnitPrice >= 0),
    CONSTRAINT CK_Items_PurchaseUnitPrice
